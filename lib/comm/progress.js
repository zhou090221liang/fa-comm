...
module.exports = class ProgressBar {
    ...
    * autoSpeedUnit：Boolean类型，表示是否自动转换单位，注意，该配置项只能用于文件上传下载等操作，render/show方法传入的值单位必须是字节
    */
    constructor(configuration) {
        ...
        configuration.autoSpeedUnit = configuration.autoSpeedUnit != undefined ? configuration.autoSpeedUnit : true;
        //是否显示预计剩余时间
